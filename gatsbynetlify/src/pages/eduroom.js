            ...
            <div style={{display:"grid",gridTemplateRows:"auto auto"}}>
                ...
                <div style={{paddingTop:'20px',paddingLeft:"80px"}}>
                    <div style={{display:"grid",gridTemplateColumns:"40% 60%"}}>
                        ...
                        <div>
                            <div className="des" style={{paddingLeft:"10px"}}>In this project, I design database, convert design from UI to HTML&CSS using NextJs, and coding backend to connect database in part of forum page.</div>
