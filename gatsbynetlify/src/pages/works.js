      ...
      <div className="container">
        <div>
          ...
          <div className="name_card">
            <a className="card1"  href="/eduroom">eduroom
          ...
          <div className="name_card">
            <a className="card_setthi" href="/setthi">setthi
        ...
        <div className="row_card">
          ...
          <div className="name_card">
            <a className="card_vcare"  href="/vcare">vcare
          ...
          <div className="name_card">
            <a className="card_famashi"  href="/famashi">famashi
          ...
          <div className="name_card">
            <a className="card_planme"  href="/planme">planme
