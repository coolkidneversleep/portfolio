        ...
        <div className="prj_intro">
          <div>
            ...
            <div
              ...
              style={{ paddingTop: "50px", paddingRight: "40px" }}
            >
              Eduroom, online learning platform, is a project of integrated
              project 1 subject. This website consist of private tutors,
              courses, forums, etc.
            </div>
            <div className="des_div">
              ...
              <div>
                ...
                <div className="sub_description">
                  <a className="website" href="https://eduroom.cscms.me">
        ...
        <div className="more_container">
          <div className="more_div">
            <div className="more_col">
              ...
              <div className="des">
                In this project, I design database, convert design from UI to
                HTML&CSS using NextJs, and coding backend to connect database in
                part of forum page.
              </div>
            </div>
            <div className="more_col">
