        ...
        <div className="prj_intro">
          <div>
            ...
            <div className="type" style={{ paddingTop: "0px" }}>
              Term project for AI class
            </div>
            <div
              className="description"
              style={{ paddingTop: "30px", paddingRight: "40px" }}
            >
              Build the object detection model to detect the papaya from images
              by using the Darknet with YOLOv4 detector. And build the image
              classification model by using CNN model which is combined with
              VGG16 model to classify the ripeness of papaya.
            </div>
          ...
          <div style={{ paddingLeft: "3px", paddingTop: "50px" }}>
