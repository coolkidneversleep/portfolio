      ...
      <div className="prj_div">
        <div className="prj_intro">
          <div>
            ...
            >
              English handwriting regcognition
            </div>
            ...
            >
              Develop a classification model that can classify characters of
              English handwriting from the image. The system will receive the
              image from the user and use Canny to perform bounding boxes around
              each character. And then pass each bounding box to the model to
          ...
          <div style={{ paddingLeft: "3vw", paddingTop: "50px" }}>
