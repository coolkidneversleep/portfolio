            ...
            <div className="prj_div">
                <div className="prj_intro">
                    <div>
                        ...
                        <div className="type" style={{paddingTop:"0px"}}>music mood classification for a workout program application</div>
                        <div className="description" style={{paddingTop:"30px", paddingRight:"40px"}}>
                        is a mobile application for the user to generate new music tracks via a Melodistic combiner system and process the music via a Melodistic processor system.                        </div>
                        <div className="des_div">
                            ...
                            <div>
                                ...
                                <div className="sub_description"><a className="website" href="https://github.com/melodistic/Melodistic-App">https://github.com/melodistic/Melodistic-App</a></div>
                            </div>
                        </div>
                    </div>
                
                    <div data-sal="slide-left" data-sal-duration="2000" data-sal-delay="2" data-sal-easing="easeOutBreak" style={{paddingLeft:"75px", paddingTop:"40px"}}>
                        <div>
                ...
                <div className="more_container">
                    <div className="more_div">
                        <div className="more_col">
                            ...
                            <div className="des">Frontend Development, Testing application</div>
                        </div>
                        <div className="more_col">
